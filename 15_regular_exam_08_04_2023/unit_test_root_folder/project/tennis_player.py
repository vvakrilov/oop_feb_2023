...
# player1 = TennisPlayer("Player", 20, 22.22)
# other1 = TennisPlayer('OtherName', 20, 33.33)
# result1 = player1 < other1
# print(player1.points, other1.points)
# print(str(result1))
#
# player2 = TennisPlayer("Player", 20, 33.33)
# other2 = TennisPlayer('OtherName', 20, 22.22)
# result2 = player2 < other2
# print(player2.points, other2.points)
# print(str(result2))
